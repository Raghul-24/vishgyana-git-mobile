...
import 'package:git_mobile/src/features/home_screen/UI/side_drawer.dart';
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Text("Hi ${homeProvider.profileResponse?.login.toString()}",style: TextStyles.mediumTitleText.copyWith(color: AppColors.whiteColor),),
                    ),
                  ),
                  Positioned(
                    bottom: -70,
                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: CommonListTile(
                            image: homeProvider.profileResponse?.avatarUrl.toString(),
                            isHeader: true,
                            subtitleName: homeProvider.profileResponse?.company.toString(),
                            titleName: homeProvider.profileResponse?.login.toString(),
                          ),
                        ),
                      ),
                    )
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CommonListTile(
                        ...
                        subtitleName: "VGTS",
                        titleName: "homeProvider.repoListResponse?.name.toString()",
                      ),
                      CommonListTile(
                        image: "https://dailycart.com/cdn/shop/products/white-potatoes_8433aa9f-73ba-4a6a-845f-af672580578a.jpg?v=1640381551&width=600",
                        subtitleName: "VGTS",
